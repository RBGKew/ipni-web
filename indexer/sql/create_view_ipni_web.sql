...
CREATE OR REPLACE VIEW ipni_web AS
 SELECT 'urn:lsid:ipni.org:names:'||ipni_flat_joined.id AS id,
    ...
    ipni_flat_joined.conserved_against_id AS lookup_conserved_against_id,
    ipni_flat_joined.correction_of_id AS lookup_correction_of_id,
    ...
    ipni_flat_joined.isonym_of_id AS lookup_isonym_of_id,
    ...
    ipni_flat_joined.replaced_synonym_id AS lookup_replaced_synonym_id,
    ...
    ipni_flat_joined.type_id AS lookup_type_id,
